...
public class RoundImageViewSkin extends SkinBase<RoundImageView> {
    ...
    public RoundImageViewSkin(RoundImageView control) {
        super(control);
        control.setStyle("-fx-background-color: transparent; -fx-border-color: transparent");

        imageView = new ImageView();
        imageView.setPreserveRatio(true);
        imageView.setSmooth(true);
        imageView.setStyle("-fx-background-color: darkgrey; -fx-border-color: transparent");
        imageView.getStyleClass().add("round-image-view");
        ...
        /*getSkinnable().setMaxWidth(200);
        getSkinnable().setMinWidth(200);
        getSkinnable().setMaxHeight(150.0);
        getSkinnable().setMinHeight(150.0);*/
    }
